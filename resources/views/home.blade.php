 ...
 <!-- Off Canvas Button -->
  <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasRight" aria-labelledby="offcanvasRightLabel">
    <div class="offcanvas-header">
      ...
      <button type="button" class="btn-close text-reset z-index-1" data-bs-dismiss="offcanvas" aria-label="Close"><i
    ...
    <div class="offcanvas-body text-center mx-auto">
      ...
      <div class="flex mt-5 d-grid offcanvas-collapse">
        <a class="btn block" data-bs-toggle="collapse" data-bs-target="#collapseExample" aria-expanded="false"
        ...
        <a class="btn block" data-bs-toggle="collapse" data-bs-target="#collapseExample1" aria-expanded="false"
          aria-controls="collapseExample">
          Themes
          <i class="fas fa-chevron-up float-right"></i>
        </a>
  ...
  <main class="content-wrapper">
    <div class="content mx-auto">
      <div class="container-fluid">
        <!-- Top Statistics -->
        <div class="row py-4">
          <div class="col-xl-3 col-sm-6 animate__animated animate__zoomIn animate__faster">
            <div class="card card-mini mb-4">
              <div class="card-body">
                ...
                <div class="chartjs-wrapper">
                  ...
                  <canvas id="barChart" width="304" height="200" style="display: block; width: 152px; height: 100px;"
            ...
            <div class="card card-mini  mb-4">
              <div class="card-body">
                ...
                <div class="chartjs-wrapper">
                  ...
                  <canvas id="dual-line" width="304" height="200" style="display: block; width: 152px; height: 100px;"
                    class="chartjs-render-monitor"></canvas>
                </div>
              </div>
            </div>
            ...
            <div class="card card-mini mb-4">
              <div class="card-body">
                ...
                <div class="chartjs-wrapper">
                  ...
                  <canvas id="area-chart" width="304" height="200" style="display: block; width: 152px; height: 100px;"
                    class="chartjs-render-monitor"></canvas>
                </div>
              </div>
            </div>
            ...
            <div class="card card-mini mb-4">
              <div class="card-body">
                ...
                <div class="chartjs-wrapper">
                  ...
                  <canvas id="line" width="304" height="200" style="display: block; width: 152px; height: 100px;"
                    class="chartjs-render-monitor"></canvas>
                </div>
              </div>
            </div>
        ...
        <div class="row">
          <div
            class="col-xl-8 col-md-12 animate__animated animate__zoomIn animate__faster animate__animated animate__zoomIn animate__faster">
            <!-- Sales Graph -->
            <div class="card card-default" data-scroll-height="675" style="height: 675px; overflow: hidden;">
              ...
              <div class="card-body">
                ...
                <canvas id="linechart" class="chartjs chartjs-render-monitor" width="1074" height="866"
                  style="display: block; width: 537px; height: 433px;"></canvas>
              </div>
          ...
          <div class="col-xl-4 col-md-12 animate__animated animate__zoomIn animate__faster">
            <!-- Doughnut Chart -->
            <div class="card card-default" data-scroll-height="675" style="height: 675px; overflow: hidden;">
              ...
              <div class="card-body">
                ...
                <canvas id="doChart" width="444" height="646" style="display: block; width: 222px; height: 323px;"
                  class="chartjs-render-monitor"></canvas>
              </div>
        ...
        <div class="row mt-5">
          <div
            class="col-xl-4 col-lg-6 col-12 animate__animated animate__zoomIn animate__faster animate__animated animate__zoomIn animate__faster">
              ...
              <div class="card-body pt-0">
                ...
                <div class="tab-content" id="pills-tabContent">
                  <div class="tab-pane fade show active" id="pills-home" role="tabpanel"
                    ...
                    <canvas id="polar" width="444" height="540" style="display: block; width: 222px; height: 270px;"
                      class="chartjs-render-monitor"></canvas>
                  </div>
                  <div class="tab-pane fade" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab">
                    <canvas id="radar" height="0" class="chartjs-render-monitor"
          ...
          <div class="col-xl-4 col-lg-6 col-12 animate__animated animate__zoomIn animate__faster">
            <!-- Top Sell Table -->
            <div class="card card-table-border-none" data-scroll-height="550" style="height: 550px; overflow: hidden;">
              <div class="card-header justify-content-between d-flex">
                <h4>Sold by Units</h4>
                <div>
                  <a href="" class="me-2 text-muted"><i class="fas fa-sync-alt"></i></a>
                  <div class="dropdown show d-inline-block widget-dropdown">
                    <a class="dropdown-toggle card-dropdown-icon text-muted" href="#" role="button" id="dropdown-units"
              ...
              <div class="slimScrollDiv" style="position: relative; overflow: hidden; width: auto; height: 100%;">
                ...
                <div class="slimScrollBar"
                  style="background: rgb(153, 153, 153); width: 5px; position: absolute; top: 46px; opacity: 0.4; display: none; border-radius: 7px; z-index: 99; right: 1px; height: 335.245px;">
                </div>
          ...
          <div class="col-xl-4 col-12 animate__animated animate__zoomIn animate__faster">
            <!-- Notification Table -->
            <div class="card card-default" data-scroll-height="550" style="height: 550px; overflow: hidden;">
              <div class="card-header justify-content-between d-flex">
                ...
                <div>
                  <a href="" class="me-2 text-muted"><i class="fas fa-sync-alt"></i></a>
                  <div class="dropdown show d-inline-block widget-dropdown">
                    <a class="dropdown-toggle card-dropdown-icon text-muted" href="#" role="button"
                      id="dropdown-notification" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"
                      data-display="static"><i class="fas fa-ellipsis-v"></i></a>
              ...
              <div class="slimScrollDiv" style="position: relative; overflow: hidden; width: auto; height: 100%;">
                <div class="card-body slim-scroll" style="overflow: hidden; width: auto; height: 100%;">
                  <div class="media pb-3 d-flex align-items-center justify-content-between">
                    <div
                      class="rounded-circle align-items-center justify-content-center c-lh-0 p-3 bg-primary text-white">
                    ...
                    <span class=" font-size-12 d-inline-block"><i class="far fa-clock"></i> 10 AM</span>
                  </div>

                  <div class="d-flex py-3 align-items-center justify-content-between">
                    <div
                      class="rounded-circle align-items-center justify-content-center c-lh-0 p-3 media-icon iconbox-45 bg-success text-white">
                    ...
                    <span class=" font-size-12 d-inline-block"><i class="far fa-clock"></i> 9 AM</span>
                  </div>


                  <div class="d-flex py-3 align-items-center justify-content-between">
                    <div
                      class="rounded-circle align-items-center justify-content-center c-lh-0 p-3 media-icon iconbox-45 bg-warning text-white">
                  ...
                  <div class="d-flex py-3 align-items-center justify-content-between">
                    <div
                      class="rounded-circle align-items-center justify-content-center c-lh-0 p-3 media-icon iconbox-45 bg-primary text-white">
                      <i class="fas fa-shopping-cart"></i>
                    </div>
                    <div class="media-body pr-3">
                      <a class="mt-0 mb-1 font-size-15 text-dark" href="#">New order</a>
                  ...
                  <div class="d-flex py-3 align-items-center justify-content-between">
                    <div
                      class="rounded-circle align-items-center justify-content-center c-lh-0 p-3 media-icon iconbox-45 bg-info text-white">
                ...
                <div class="slimScrollBar"
                  style="background: rgb(153, 153, 153); width: 5px; position: absolute; top: 0px; opacity: 0; display: block; border-radius: 7px; z-index: 99; right: 1px; height: 251.45px;">
                </div>
                <div class="slimScrollRail"
                  style="width: 5px; height: 100%; position: absolute; top: 0px; display: none; border-radius: 7px; background: rgb(51, 51, 51); opacity: 0.2; z-index: 90; right: 1px;">
                </div>
        ...
        <div class="row mt-5">
          <div class="col-12 animate__animated animate__zoomIn animate__faster">
            <!-- Recent Order Table -->
            <div class="card card-table-border-none" id="recent-orders">
              <div class="card-header justify-content-between">
                <h4>Recent Orders</h4>
                <div class="date-range-report ">
                  <span>Dec 28, 2021 - Jan 26, 2022</span>
                </div>
              </div>
              <div class="card-body pt-0 pb-5">
                <table class="table card-table text-muted table-responsive table-responsive-large" style="width:100%">
                  <thead>
                    <tr>
                      <th>Order ID</th>
                      <th>Product Name</th>
                  ...
                  <tbody>
                      ...
                      <td class="text-right">
                        <div class="dropdown show d-inline-block widget-dropdown">
                          <a class="dropdown-toggle card-dropdown-icon text-muted" href="" role="button"
                            ...
                            aria-expanded="false" data-display="static"><i class="fas fa-ellipsis-v"></i></a>
                    ...
                    <tr>
                      <td>24541</td>
                      <td>
                        <a href=""> Toddler Shoes, Gucci Watch</a>
                      </td>
                    ...
                    <tr>
                      <td>24541</td>
                      <td>
                        <a href=""> Backpack Gents, Swimming Cap Slin</a>
                      </td>
        ...
        <div class="row mt-5">
          <div class="col-xl-6 animate__animated animate__zoomIn animate__faster">
            <!-- To Do list -->
            <div class="card card-default todo-table" id="todo" data-scroll-height="550"
              ...
              <div class="slimScrollDiv" style="position: relative; overflow: hidden; width: auto; height: 100%;">
                ...
                <div class="slimScrollBar"
                  style="background: rgb(153, 153, 153); width: 5px; position: absolute; top: 0px; opacity: 0.4; display: none; border-radius: 7px; z-index: 99; right: 1px; height: 381.459px;">
                </div>
                <div class="slimScrollRail"
                  style="width: 5px; height: 100%; position: absolute; top: 0px; display: none; border-radius: 7px; background: rgb(51, 51, 51); opacity: 0.2; z-index: 90; right: 1px;">
                </div>
          ...
          <div class="col-xl-6 animate__animated animate__zoomIn animate__faster">
            ...
            <div class="card card-default">
              <div class="card-header d-block d-md-flex justify-content-between">
                <h4>World Wide Customer </h4>
                <div class="dropdown show d-inline-block widget-dropdown ml-auto">
                  <a class="dropdown-toggle card-dropdown-icon" href="#" role="button" id="world-dropdown"
              ...
              <div class="card-body vector-map-world">
                <div id="world" style="height: 100%; width: 100%;">
                  <div class="jvectormap-container" style="background-color: transparent;"><svg width="371.969"
                      height="329.922">
                      <defs></defs>
                      <g transform="scale(0.4132988888888888) translate(6.876793089575639e-14, 178.77929921420287)">
                        <path
                          ...
                          data-code="BD" fill="#e4e4e4" fill-opacity="0.9" stroke="none" stroke-width="0"
                          stroke-opacity="0" fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                        <path
                          ...
                          data-code="BE" fill="#e4e4e4" fill-opacity="0.9" stroke="none" stroke-width="0"
                          stroke-opacity="0" fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                        <path
                          ...
                          data-code="BF" fill="#e4e4e4" fill-opacity="0.9" stroke="none" stroke-width="0"
                          stroke-opacity="0" fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                        <path
                          ...
                          data-code="BG" fill="#e4e4e4" fill-opacity="0.9" stroke="none" stroke-width="0"
                          stroke-opacity="0" fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                        <path
                          ...
                          data-code="BA" fill="#e4e4e4" fill-opacity="0.9" stroke="none" stroke-width="0"
                          stroke-opacity="0" fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                        <path d="M707.48,273.58l0.68,-0.65l1.41,-0.91l-0.15,1.63l-0.81,-0.05l-0.61,0.58l-0.53,-0.6Z"
                          data-code="BN" fill="#e4e4e4" fill-opacity="0.9" stroke="none" stroke-width="0"
                          stroke-opacity="0" fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                        <path
                          ...
                          data-code="BO" fill="#e4e4e4" fill-opacity="0.9" stroke="none" stroke-width="0"
                          stroke-opacity="0" fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                        <path
                          ...
                          data-code="JP" fill="#e4e4e4" fill-opacity="0.9" stroke="none" stroke-width="0"
                          stroke-opacity="0" fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                        <path d="M495.45,295.49l-1.08,-2.99l1.14,-0.11l0.64,-1.19l0.76,0.09l0.65,1.83l-2.1,2.36Z"
                          data-code="BI" fill="#e4e4e4" fill-opacity="0.9" stroke="none" stroke-width="0"
                          stroke-opacity="0" fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                        <path
                          ...
                          data-code="BJ" fill="#e4e4e4" fill-opacity="0.9" stroke="none" stroke-width="0"
                          stroke-opacity="0" fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                        <path
                          d="M650.32,213.86l0.84,0.71l-0.12,1.1l-3.76,-0.11l-1.57,0.4l-1.93,-0.87l1.48,-1.96l1.13,-0.57l1.63,0.57l1.33,0.08l0.99,0.65Z"
                          data-code="BT" fill="#e4e4e4" fill-opacity="0.9" stroke="none" stroke-width="0"
                          stroke-opacity="0" fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                        <path d="M228.38,239.28l-0.8,0.4l-2.26,-1.06l0.84,-0.23l2.14,0.3l1.17,0.56l-1.08,0.03Z"
                          data-code="JM" fill="#e4e4e4" fill-opacity="0.9" stroke="none" stroke-width="0"
                          stroke-opacity="0" fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                        <path
                          ...
                          data-code="BW" fill="#e4e4e4" fill-opacity="0.9" stroke="none" stroke-width="0"
                          stroke-opacity="0" fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                        <path
                          ...
                          data-code="BR" fill="#e4e4e4" fill-opacity="0.9" stroke="none" stroke-width="0"
                          stroke-opacity="0" fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                        <path
                          ...
                          data-code="BS" fill="#e4e4e4" fill-opacity="0.9" stroke="none" stroke-width="0"
                          stroke-opacity="0" fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                        <path
                          ...
                          data-code="BY" fill="#e4e4e4" fill-opacity="0.9" stroke="none" stroke-width="0"
                          stroke-opacity="0" fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                        <path
                          d="M198.03,244.38l0.1,-4.49l0.69,-0.06l0.74,-1.3l0.34,0.28l-0.4,1.3l0.17,0.58l-0.34,2.25l-1.3,1.42Z"
                          data-code="BZ" fill="#e4e4e4" fill-opacity="0.9" stroke="none" stroke-width="0"
                          stroke-opacity="0" fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                        <path
                          ...
                          data-code="RU" fill="#e4e4e4" fill-opacity="0.9" stroke="none" stroke-width="0"
                          stroke-opacity="0" fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                        <path
                          d="M497.0,288.25l0.71,1.01l-0.11,1.09l-1.63,0.03l-1.04,1.39l-0.83,-0.11l0.51,-1.2l0.08,-1.34l0.42,-0.41l0.7,0.14l1.19,-0.61Z"
                          data-code="RW" fill="#e4e4e4" fill-opacity="0.9" stroke="none" stroke-width="0"
                          stroke-opacity="0" fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                        <path
                          ...
                          data-code="RS" fill="#e4e4e4" fill-opacity="0.9" stroke="none" stroke-width="0"
                          stroke-opacity="0" fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                        ...
                        <path
                          ...
                          data-code="TM" fill="#e4e4e4" fill-opacity="0.9" stroke="none" stroke-width="0"
                          stroke-opacity="0" fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                        <path
                          ...
                          data-code="TJ" fill="#e4e4e4" fill-opacity="0.9" stroke="none" stroke-width="0"
                          stroke-opacity="0" fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                        <path
                          ...
                          data-code="RO" fill="#e4e4e4" fill-opacity="0.9" stroke="none" stroke-width="0"
                          stroke-opacity="0" fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                        <path
                          ...
                          data-code="GW" fill="#e4e4e4" fill-opacity="0.9" stroke="none" stroke-width="0"
                          stroke-opacity="0" fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                        <path
                          ...
                          data-code="GT" fill="#e4e4e4" fill-opacity="0.9" stroke="none" stroke-width="0"
                          stroke-opacity="0" fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                        <path
                          ...
                          data-code="GR" fill="#e4e4e4" fill-opacity="0.9" stroke="none" stroke-width="0"
                          stroke-opacity="0" fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                        <path d="M448.79,279.62l0.02,2.22l-4.09,0.0l0.69,-2.27l3.38,0.05Z" data-code="GQ" fill="#e4e4e4"
                          fill-opacity="0.9" stroke="none" stroke-width="0" stroke-opacity="0" fill-rule="evenodd"
                        ...
                        <path
                          ...
                          data-code="GY" fill="#e4e4e4" fill-opacity="0.9" stroke="none" stroke-width="0"
                          stroke-opacity="0" fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                        <path
                          ...
                          data-code="GE" fill="#e4e4e4" fill-opacity="0.9" stroke="none" stroke-width="0"
                          stroke-opacity="0" fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                        <path
                          ...
                          data-code="GB" fill="#e4e4e4" fill-opacity="0.9" stroke="none" stroke-width="0"
                          stroke-opacity="0" fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                        <path
                          ...
                          data-code="GA" fill="#e4e4e4" fill-opacity="0.9" stroke="none" stroke-width="0"
                          stroke-opacity="0" fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                        <path
                          d="M391.8,254.11l0.47,0.8l1.11,-0.32l0.98,0.7l1.07,0.2l2.26,-1.22l0.64,0.44l1.13,1.56l-0.48,1.4l0.8,0.3l-0.08,0.48l0.46,0.68l-0.35,1.36l1.05,2.61l-1.0,0.69l0.03,1.41l-0.72,-0.06l-1.08,1.0l-0.24,-0.27l0.07,-1.11l-1.05,-1.54l-1.79,0.21l-0.35,-2.01l-1.6,-2.18l-2.0,-0.0l-1.31,0.54l-1.95,2.18l-1.86,-2.19l-1.2,-0.78l-0.3,-1.11l-0.8,-0.85l0.65,-0.72l0.81,-0.03l1.64,-0.8l0.23,-1.87l2.67,0.64l0.89,-0.3l1.21,0.15Z"
                          data-code="GN" fill="#e4e4e4" fill-opacity="0.9" stroke="none" stroke-width="0"
                          stroke-opacity="0" fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                        <path
                          ...
                          data-code="GM" fill="#e4e4e4" fill-opacity="0.9" stroke="none" stroke-width="0"
                          stroke-opacity="0" fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                        <path
                          ...
                          data-code="GL" fill="#e4e4e4" fill-opacity="0.9" stroke="none" stroke-width="0"
                          stroke-opacity="0" fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                        <path
                          ...
                          data-code="GH" fill="#e4e4e4" fill-opacity="0.9" stroke="none" stroke-width="0"
                          stroke-opacity="0" fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                        <path
                          ...
                          data-code="OM" fill="#e4e4e4" fill-opacity="0.9" stroke="none" stroke-width="0"
                          stroke-opacity="0" fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                        <path
                          d="M448.1,188.24l-1.0,1.27l-0.02,1.32l0.84,0.88l-0.28,2.09l-1.53,1.32l-0.12,0.42l0.48,1.54l1.42,0.32l0.53,1.11l0.9,0.52l-0.11,1.67l-3.54,2.64l-0.1,2.38l-0.58,0.3l-0.96,-4.45l-1.54,-1.25l-0.16,-0.78l-1.92,-1.56l-0.18,-1.76l1.51,-1.62l0.59,-2.34l-0.38,-2.78l0.42,-1.21l2.45,-1.05l1.29,0.26l-0.06,1.11l0.58,0.38l1.47,-0.73Z"
                          data-code="TN" fill="#e4e4e4" fill-opacity="0.9" stroke="none" stroke-width="0"
                          stroke-opacity="0" fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                        <path
                          ...
                          data-code="JO" fill="#e4e4e4" fill-opacity="0.9" stroke="none" stroke-width="0"
                          stroke-opacity="0" fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                        <path
                          ...
                          data-code="HR" fill="#e4e4e4" fill-opacity="0.9" stroke="none" stroke-width="0"
                          stroke-opacity="0" fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                        <path
                          ...
                          data-code="HT" fill="#e4e4e4" fill-opacity="0.9" stroke="none" stroke-width="0"
                          stroke-opacity="0" fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                        <path
                          ...
                          data-code="HU" fill="#e4e4e4" fill-opacity="0.9" stroke="none" stroke-width="0"
                          stroke-opacity="0" fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                        <path
                          ...
                          data-code="HN" fill="#e4e4e4" fill-opacity="0.9" stroke="none" stroke-width="0"
                          stroke-opacity="0" fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                        ...
                        <path
                          ...
                          data-code="PS" fill="#e4e4e4" fill-opacity="0.9" stroke="none" stroke-width="0"
                          stroke-opacity="0" fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                        <path
                          ...
                          data-code="PT" fill="#e4e4e4" fill-opacity="0.9" stroke="none" stroke-width="0"
                          stroke-opacity="0" fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                        <path
                          ...
                          data-code="PY" fill="#e4e4e4" fill-opacity="0.9" stroke="none" stroke-width="0"
                          stroke-opacity="0" fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                        <path
                          ...
                          data-code="PA" fill="#e4e4e4" fill-opacity="0.9" stroke="none" stroke-width="0"
                          stroke-opacity="0" fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                        <path
                          ...
                          data-code="PG" fill="#e4e4e4" fill-opacity="0.9" stroke="none" stroke-width="0"
                          stroke-opacity="0" fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                        <path
                          ...
                          data-code="PE" fill="#e4e4e4" fill-opacity="0.9" stroke="none" stroke-width="0"
                          stroke-opacity="0" fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                        <path
                          ...
                          data-code="PK" fill="#e4e4e4" fill-opacity="0.9" stroke="none" stroke-width="0"
                          stroke-opacity="0" fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                        <path
                          ...
                          data-code="PH" fill="#e4e4e4" fill-opacity="0.9" stroke="none" stroke-width="0"
                          stroke-opacity="0" fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                        <path
                          ...
                          data-code="PL" fill="#e4e4e4" fill-opacity="0.9" stroke="none" stroke-width="0"
                          stroke-opacity="0" fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                        <path
                          ...
                          data-code="ZM" fill="#e4e4e4" fill-opacity="0.9" stroke="none" stroke-width="0"
                          stroke-opacity="0" fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                        <path
                          ...
                          data-code="EH" fill="#e4e4e4" fill-opacity="0.9" stroke="none" stroke-width="0"
                          stroke-opacity="0" fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                        <path
                          ...
                          data-code="EE" fill="#e4e4e4" fill-opacity="0.9" stroke="none" stroke-width="0"
                          stroke-opacity="0" fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                        <path
                          ...
                          data-code="EG" fill="#e4e4e4" fill-opacity="0.9" stroke="none" stroke-width="0"
                          stroke-opacity="0" fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                        <path
                          ...
                          data-code="ZA" fill="#e4e4e4" fill-opacity="0.9" stroke="none" stroke-width="0"
                          stroke-opacity="0" fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                        <path
                          ...
                          data-code="EC" fill="#e4e4e4" fill-opacity="0.9" stroke="none" stroke-width="0"
                          stroke-opacity="0" fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                        <path
                          ...
                          data-code="IT" fill="#e4e4e4" fill-opacity="0.9" stroke="none" stroke-width="0"
                          stroke-opacity="0" fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                        <path
                          ...
                          data-code="VN" fill="#e4e4e4" fill-opacity="0.9" stroke="none" stroke-width="0"
                          stroke-opacity="0" fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                        <path
                          ...
                          data-code="SB" fill="#e4e4e4" fill-opacity="0.9" stroke="none" stroke-width="0"
                          stroke-opacity="0" fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                        <path
                          ...
                          data-code="ET" fill="#e4e4e4" fill-opacity="0.9" stroke="none" stroke-width="0"
                          stroke-opacity="0" fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                        <path
                          ...
                          data-code="SO" fill="#e4e4e4" fill-opacity="0.9" stroke="none" stroke-width="0"
                          stroke-opacity="0" fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                        <path
                          d="M498.91,341.09l-1.11,-0.22l-0.92,0.28l-2.09,-0.44l-1.5,-1.11l-1.89,-0.43l-0.62,-1.4l-0.01,-0.84l-0.3,-0.38l-0.97,-0.25l-2.71,-2.74l-1.92,-3.32l3.83,0.45l3.73,-3.82l1.08,-0.44l0.26,-0.77l1.25,-0.9l1.41,-0.26l0.5,0.89l1.99,-0.05l1.72,1.17l1.11,0.17l1.05,0.66l0.01,2.99l-0.59,3.76l0.38,0.86l-0.23,1.23l-0.39,0.35l-0.63,1.81l-2.43,2.75Z"
                          data-code="ZW" fill="#e4e4e4" fill-opacity="0.9" stroke="none" stroke-width="0"
                          stroke-opacity="0" fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                        <path
                          ...
                          data-code="ES" fill="#e4e4e4" fill-opacity="0.9" stroke="none" stroke-width="0"
                          stroke-opacity="0" fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                        <path
                          ...
                          data-code="ER" fill="#e4e4e4" fill-opacity="0.9" stroke="none" stroke-width="0"
                          stroke-opacity="0" fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                        <path
                          d="M468.91,172.53l-1.22,-1.02l0.47,-1.81l0.89,-0.72l2.26,1.51l-0.5,0.57l-0.75,-0.27l-1.14,1.73Z"
                          data-code="ME" fill="#e4e4e4" fill-opacity="0.9" stroke="none" stroke-width="0"
                          stroke-opacity="0" fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                        <path
                          ...
                          data-code="MD" fill="#e4e4e4" fill-opacity="0.9" stroke="none" stroke-width="0"
                          stroke-opacity="0" fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                        <path
                          ...
                          data-code="MG" fill="#e4e4e4" fill-opacity="0.9" stroke="none" stroke-width="0"
                          stroke-opacity="0" fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                        <path
                          ...
                          data-code="MA" fill="#e4e4e4" fill-opacity="0.9" stroke="none" stroke-width="0"
                          stroke-opacity="0" fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                        <path
                          ...
                          data-code="UZ" fill="#e4e4e4" fill-opacity="0.9" stroke="none" stroke-width="0"
                          stroke-opacity="0" fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                        <path
                          ...
                          data-code="MM" fill="#e4e4e4" fill-opacity="0.9" stroke="none" stroke-width="0"
                          stroke-opacity="0" fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                        <path
                          ...
                          data-code="ML" fill="#e4e4e4" fill-opacity="0.9" stroke="none" stroke-width="0"
                          stroke-opacity="0" fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                        <path
                          ...
                          data-code="MN" fill="#e4e4e4" fill-opacity="0.9" stroke="none" stroke-width="0"
                          stroke-opacity="0" fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                        <path
                          ...
                          data-code="MK" fill="#e4e4e4" fill-opacity="0.9" stroke="none" stroke-width="0"
                          stroke-opacity="0" fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                        <path
                          ...
                          data-code="MW" fill="#e4e4e4" fill-opacity="0.9" stroke="none" stroke-width="0"
                          stroke-opacity="0" fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                        <path
                          ...
                          data-code="MR" fill="#e4e4e4" fill-opacity="0.9" stroke="none" stroke-width="0"
                          stroke-opacity="0" fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                        <path
                          ...
                          data-code="UG" fill="#e4e4e4" fill-opacity="0.9" stroke="none" stroke-width="0"
                          stroke-opacity="0" fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                        <path
                          ...
                          data-code="MY" fill="#e4e4e4" fill-opacity="0.9" stroke="none" stroke-width="0"
                          stroke-opacity="0" fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                        <path
                          ...
                          data-code="MX" fill="#e4e4e4" fill-opacity="0.9" stroke="none" stroke-width="0"
                          stroke-opacity="0" fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                        <path
                          ...
                          data-code="IL" fill="#e4e4e4" fill-opacity="0.9" stroke="none" stroke-width="0"
                          stroke-opacity="0" fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                        <path
                        ...
                        <path
                          ...
                          data-code="FJ" fill="#e4e4e4" fill-opacity="0.9" stroke="none" stroke-width="0"
                          stroke-opacity="0" fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                        <path
                          ...
                          data-code="FK" fill="#e4e4e4" fill-opacity="0.9" stroke="none" stroke-width="0"
                          stroke-opacity="0" fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                        <path
                          ...
                          data-code="NI" fill="#e4e4e4" fill-opacity="0.9" stroke="none" stroke-width="0"
                          stroke-opacity="0" fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                        <path
                          ...
                          data-code="NL" fill="#e4e4e4" fill-opacity="0.9" stroke="none" stroke-width="0"
                          stroke-opacity="0" fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                        <path
                          ...
                          data-code="NO" fill="#e4e4e4" fill-opacity="0.9" stroke="none" stroke-width="0"
                          stroke-opacity="0" fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                        <path
                          ...
                          data-code="NA" fill="#e4e4e4" fill-opacity="0.9" stroke="none" stroke-width="0"
                          stroke-opacity="0" fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                        <path d="M839.04,322.8l0.22,1.14l-0.44,0.03l-0.2,-1.45l0.42,0.27Z" data-code="VU" fill="#e4e4e4"
                          fill-opacity="0.9" stroke="none" stroke-width="0" stroke-opacity="0" fill-rule="evenodd"
                          class="jvectormap-region jvectormap-element"></path>
                        ...
                        <path
                          ...
                          data-code="NE" fill="#e4e4e4" fill-opacity="0.9" stroke="none" stroke-width="0"
                          stroke-opacity="0" fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                        <path
                          ...
                          data-code="NG" fill="#e4e4e4" fill-opacity="0.9" stroke="none" stroke-width="0"
                          stroke-opacity="0" fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                        <path
                          ...
                          data-code="NZ" fill="#e4e4e4" fill-opacity="0.9" stroke="none" stroke-width="0"
                          stroke-opacity="0" fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                        <path
                          ...
                          data-code="NP" fill="#e4e4e4" fill-opacity="0.9" stroke="none" stroke-width="0"
                          stroke-opacity="0" fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                        <path d="M472.77,172.64l-1.08,-1.29l0.96,-0.77l0.29,-0.83l1.98,1.64l-0.36,0.67l-1.79,0.58Z"
                          data-code="XK" fill="#e4e4e4" fill-opacity="0.9" stroke="none" stroke-width="0"
                          stroke-opacity="0" fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                        <path
                          ...
                          data-code="CI" fill="#e4e4e4" fill-opacity="0.9" stroke="none" stroke-width="0"
                          stroke-opacity="0" fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                        <path
                          ...
                          data-code="CH" fill="#e4e4e4" fill-opacity="0.9" stroke="none" stroke-width="0"
                          stroke-opacity="0" fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                        <path
                          ...
                          data-code="CO" fill="#e4e4e4" fill-opacity="0.9" stroke="none" stroke-width="0"
                          stroke-opacity="0" fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                        <path
                          ...
                          data-code="CN" fill="#e4e4e4" fill-opacity="0.9" stroke="none" stroke-width="0"
                          stroke-opacity="0" fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                        <path
                          ...
                          data-code="CM" fill="#e4e4e4" fill-opacity="0.9" stroke="none" stroke-width="0"
                          stroke-opacity="0" fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                        <path
                          ...
                          data-code="CL" fill="#e4e4e4" fill-opacity="0.9" stroke="none" stroke-width="0"
                          stroke-opacity="0" fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                        <path d="M504.91,192.87l0.34,0.01l0.27,-0.07l-0.29,0.26l-0.31,-0.2Z" data-code="XC"
                          fill="#e4e4e4" fill-opacity="0.9" stroke="none" stroke-width="0" stroke-opacity="0"
                          fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                        <path
                          ...
                          data-code="CA" fill="#e4e4e4" fill-opacity="0.9" stroke="none" stroke-width="0"
                          stroke-opacity="0" fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                        <path
                          ...
                          data-code="CG" fill="#e4e4e4" fill-opacity="0.9" stroke="none" stroke-width="0"
                          stroke-opacity="0" fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                        <path
                          ...
                          data-code="CF" fill="#e4e4e4" fill-opacity="0.9" stroke="none" stroke-width="0"
                          stroke-opacity="0" fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                        <path
                          ...
                          data-code="CD" fill="#e4e4e4" fill-opacity="0.9" stroke="none" stroke-width="0"
                          stroke-opacity="0" fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                        <path
                          ...
                          data-code="CZ" fill="#e4e4e4" fill-opacity="0.9" stroke="none" stroke-width="0"
                          stroke-opacity="0" fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                        ...
                        <path
                          ...
                          data-code="CR" fill="#e4e4e4" fill-opacity="0.9" stroke="none" stroke-width="0"
                          stroke-opacity="0" fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                        <path
                          ...
                          data-code="CU" fill="#e4e4e4" fill-opacity="0.9" stroke="none" stroke-width="0"
                          stroke-opacity="0" fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                        <path
                          d="M500.35,351.36l0.5,2.04l-0.38,0.89l-1.05,0.21l-1.23,-1.2l-0.02,-0.64l0.83,-1.57l1.34,0.27Z"
                          data-code="SZ" fill="#e4e4e4" fill-opacity="0.9" stroke="none" stroke-width="0"
                          stroke-opacity="0" fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                        <path
                          ...
                          data-code="SY" fill="#e4e4e4" fill-opacity="0.9" stroke="none" stroke-width="0"
                          stroke-opacity="0" fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                        <path
                          ...
                          data-code="KG" fill="#e4e4e4" fill-opacity="0.9" stroke="none" stroke-width="0"
                          stroke-opacity="0" fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                        <path
                          d="M506.26,284.69l1.87,-2.56l0.93,-2.15l-1.38,-4.08l-1.06,-1.6l2.82,-2.75l0.79,0.26l0.12,1.41l0.86,0.83l1.9,0.11l3.28,2.13l3.57,0.44l1.05,-1.12l1.96,-0.9l0.82,0.68l1.16,0.09l-1.78,2.45l0.03,9.12l1.3,1.94l-1.37,0.78l-0.67,1.03l-1.08,0.46l-0.34,1.67l-0.81,1.07l-0.45,1.55l-0.68,0.56l-3.2,-2.23l-0.35,-1.58l-8.86,-4.98l0.14,-1.6l-0.57,-1.04Z"
                          data-code="KE" fill="#e4e4e4" fill-opacity="0.9" stroke="none" stroke-width="0"
                          stroke-opacity="0" fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                        <path
                          ...
                          data-code="SS" fill="#e4e4e4" fill-opacity="0.9" stroke="none" stroke-width="0"
                          stroke-opacity="0" fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                        <path
                          ...
                          data-code="SR" fill="#e4e4e4" fill-opacity="0.9" stroke="none" stroke-width="0"
                          stroke-opacity="0" fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                        <path
                          ...
                          data-code="KH" fill="#e4e4e4" fill-opacity="0.9" stroke="none" stroke-width="0"
                          stroke-opacity="0" fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                        <path
                          d="M195.8,250.13l1.4,-1.19l2.24,1.45l0.98,-0.27l0.44,0.2l-0.27,1.05l-1.14,-0.03l-3.64,-1.21Z"
                          data-code="SV" fill="#e4e4e4" fill-opacity="0.9" stroke="none" stroke-width="0"
                          stroke-opacity="0" fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                        <path
                          ...
                          data-code="SK" fill="#e4e4e4" fill-opacity="0.9" stroke="none" stroke-width="0"
                          stroke-opacity="0" fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                        <path
                          ...
                          data-code="KR" fill="#e4e4e4" fill-opacity="0.9" stroke="none" stroke-width="0"
                          stroke-opacity="0" fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                        <path
                        ...
                        <path
                          ...
                          data-code="SN" fill="#e4e4e4" fill-opacity="0.9" stroke="none" stroke-width="0"
                          stroke-opacity="0" fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                        <path
                          ...
                          data-code="SL" fill="#e4e4e4" fill-opacity="0.9" stroke="none" stroke-width="0"
                          stroke-opacity="0" fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                        <path
                          ...
                          data-code="KZ" fill="#e4e4e4" fill-opacity="0.9" stroke="none" stroke-width="0"
                          stroke-opacity="0" fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                        <path
                          ...
                          data-code="SA" fill="#e4e4e4" fill-opacity="0.9" stroke="none" stroke-width="0"
                          stroke-opacity="0" fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                        <path
                          ...
                          data-code="SE" fill="#e4e4e4" fill-opacity="0.9" stroke="none" stroke-width="0"
                          stroke-opacity="0" fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                        <path
                          ...
                          data-code="SD" fill="#e4e4e4" fill-opacity="0.9" stroke="none" stroke-width="0"
                          stroke-opacity="0" fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                        <path
                          ...
                          data-code="DO" fill="#e4e4e4" fill-opacity="0.9" stroke="none" stroke-width="0"
                          stroke-opacity="0" fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                        <path
                          ...
                          data-code="DJ" fill="#e4e4e4" fill-opacity="0.9" stroke="none" stroke-width="0"
                          stroke-opacity="0" fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                        <path
                          ...
                          data-code="DK" fill="#e4e4e4" fill-opacity="0.9" stroke="none" stroke-width="0"
                          stroke-opacity="0" fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                        <path
                          ...
                          data-code="DE" fill="#e4e4e4" fill-opacity="0.9" stroke="none" stroke-width="0"
                          stroke-opacity="0" fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                        <path
                          ...
                          data-code="YE" fill="#e4e4e4" fill-opacity="0.9" stroke="none" stroke-width="0"
                          stroke-opacity="0" fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                        <path
                          ...
                          data-code="DZ" fill="#e4e4e4" fill-opacity="0.9" stroke="none" stroke-width="0"
                          stroke-opacity="0" fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                        <path
                          ...
                          data-code="US" fill="#e4e4e4" fill-opacity="0.9" stroke="none" stroke-width="0"
                          stroke-opacity="0" fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                        <path
                          ...
                          data-code="UY" fill="#e4e4e4" fill-opacity="0.9" stroke="none" stroke-width="0"
                          stroke-opacity="0" fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                        <path d="M510.37,198.01l-0.88,0.51l1.82,-3.54l0.62,0.08l0.22,0.61l-1.13,0.88l-0.65,1.47Z"
                          data-code="LB" fill="#e4e4e4" fill-opacity="0.9" stroke="none" stroke-width="0"
                          stroke-opacity="0" fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                        <path
                          ...
                          data-code="LA" fill="#e4e4e4" fill-opacity="0.9" stroke="none" stroke-width="0"
                          stroke-opacity="0" fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                        <path
                          d="M724.01,226.68l-0.74,1.48l-0.9,-1.52l-0.25,-1.74l1.38,-2.44l1.73,-1.74l0.64,0.44l-1.85,5.52Z"
                          data-code="TW" fill="#e4e4e4" fill-opacity="0.9" stroke="none" stroke-width="0"
                          stroke-opacity="0" fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                        ...
                        <path
                          ...
                          data-code="TR" fill="#e4e4e4" fill-opacity="0.9" stroke="none" stroke-width="0"
                          stroke-opacity="0" fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                        <path
                          d="M624.16,268.99l-1.82,0.48l-0.99,-1.67l-0.42,-3.46l0.95,-3.43l1.21,0.98l2.26,4.19l-0.34,2.33l-0.85,0.58Z"
                          data-code="LK" fill="#e4e4e4" fill-opacity="0.9" stroke="none" stroke-width="0"
                          stroke-opacity="0" fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                        <path
                          ...
                          data-code="LV" fill="#e4e4e4" fill-opacity="0.9" stroke="none" stroke-width="0"
                          stroke-opacity="0" fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                        <path
                          ...
                          data-code="LT" fill="#e4e4e4" fill-opacity="0.9" stroke="none" stroke-width="0"
                          stroke-opacity="0" fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                        ...
                        <path
                          ...
                          data-code="LR" fill="#e4e4e4" fill-opacity="0.9" stroke="none" stroke-width="0"
                          stroke-opacity="0" fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                        <path
                          d="M491.06,363.48l-0.49,0.15l-1.49,-1.67l1.1,-1.43l2.19,-1.44l1.51,1.27l-0.98,1.82l-1.23,0.38l-0.62,0.93Z"
                          data-code="LS" fill="#e4e4e4" fill-opacity="0.9" stroke="none" stroke-width="0"
                          stroke-opacity="0" fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                        <path
                          ...
                          data-code="TH" fill="#e4e4e4" fill-opacity="0.9" stroke="none" stroke-width="0"
                          stroke-opacity="0" fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                        <path d="M596.68,420.38l-3.2,0.18l-0.05,-1.26l0.39,-1.41l1.3,0.78l2.08,0.35l-0.52,1.36Z"
                          data-code="TF" fill="#e4e4e4" fill-opacity="0.9" stroke="none" stroke-width="0"
                          stroke-opacity="0" fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                        <path
                          ...
                          data-code="TG" fill="#e4e4e4" fill-opacity="0.9" stroke="none" stroke-width="0"
                          stroke-opacity="0" fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                        <path
                          ...
                          data-code="TD" fill="#e4e4e4" fill-opacity="0.9" stroke="none" stroke-width="0"
                          stroke-opacity="0" fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                        <path
                          ...
                          data-code="LY" fill="#e4e4e4" fill-opacity="0.9" stroke="none" stroke-width="0"
                          stroke-opacity="0" fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                        <path
                          ...
                          data-code="AE" fill="#e4e4e4" fill-opacity="0.9" stroke="none" stroke-width="0"
                          stroke-opacity="0" fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                        <path
                          ...
                          data-code="VE" fill="#e4e4e4" fill-opacity="0.9" stroke="none" stroke-width="0"
                          stroke-opacity="0" fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                        <path
                          ...
                          data-code="AF" fill="#e4e4e4" fill-opacity="0.9" stroke="none" stroke-width="0"
                          stroke-opacity="0" fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                        <path
                          ...
                          data-code="IQ" fill="#e4e4e4" fill-opacity="0.9" stroke="none" stroke-width="0"
                          stroke-opacity="0" fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                        <path
                          ...
                          data-code="IS" fill="#e4e4e4" fill-opacity="0.9" stroke="none" stroke-width="0"
                          stroke-opacity="0" fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                        <path
                          ...
                          data-code="IR" fill="#e4e4e4" fill-opacity="0.9" stroke="none" stroke-width="0"
                          stroke-opacity="0" fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                        <path
                          ...
                          data-code="AM" fill="#e4e4e4" fill-opacity="0.9" stroke="none" stroke-width="0"
                          stroke-opacity="0" fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                        <path
                          ...
                          data-code="AL" fill="#e4e4e4" fill-opacity="0.9" stroke="none" stroke-width="0"
                          stroke-opacity="0" fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                        <path
                          ...
                          data-code="AO" fill="#e4e4e4" fill-opacity="0.9" stroke="none" stroke-width="0"
                          stroke-opacity="0" fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                        <path
                          ...
                          data-code="AR" fill="#e4e4e4" fill-opacity="0.9" stroke="none" stroke-width="0"
                          stroke-opacity="0" fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                        <path
                          ...
                          data-code="AU" fill="#e4e4e4" fill-opacity="0.9" stroke="none" stroke-width="0"
                          stroke-opacity="0" fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                        <path
                          ...
                          data-code="AT" fill="#e4e4e4" fill-opacity="0.9" stroke="none" stroke-width="0"
                          stroke-opacity="0" fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                        <path
                          ...
                          data-code="IN" fill="#e4e4e4" fill-opacity="0.9" stroke="none" stroke-width="0"
                          stroke-opacity="0" fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                        <path
                          ...
                          data-code="TZ" fill="#e4e4e4" fill-opacity="0.9" stroke="none" stroke-width="0"
                          stroke-opacity="0" fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                        <path
                          ...
                          data-code="AZ" fill="#e4e4e4" fill-opacity="0.9" stroke="none" stroke-width="0"
                          stroke-opacity="0" fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                        <path
                          ...
                          data-code="IE" fill="#e4e4e4" fill-opacity="0.9" stroke="none" stroke-width="0"
                          stroke-opacity="0" fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                        <path
                          ...
                          data-code="ID" fill="#e4e4e4" fill-opacity="0.9" stroke="none" stroke-width="0"
                          stroke-opacity="0" fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                        <path
                          ...
                          data-code="UA" fill="#e4e4e4" fill-opacity="0.9" stroke="none" stroke-width="0"
                          stroke-opacity="0" fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                        <path d="M549.33,221.64l-0.76,-0.23l-0.14,-1.64l0.84,-1.29l0.47,0.52l0.04,1.34l-0.45,1.3Z"
                          data-code="QA" fill="#e4e4e4" fill-opacity="0.9" stroke="none" stroke-width="0"
                          stroke-opacity="0" fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                        <path
                          ...
                          data-code="MZ" fill="#e4e4e4" fill-opacity="0.9" stroke="none" stroke-width="0"
                          stroke-opacity="0" fill-rule="evenodd" class="jvectormap-region jvectormap-element"></path>
                      </g>
                      <g></g>
                      <g>
                        <circle data-index="0" cx="109.45588266108987" cy="128.5899802413074" fill="limegreen"
                          stroke="transparent" fill-opacity="1" stroke-width="1" stroke-opacity="1" r="5"
                          class="jvectormap-marker jvectormap-element"></circle>
                        <circle data-index="1" cx="186.18898995980027" cy="116.7764410573164" fill="orange"
                          stroke="transparent" fill-opacity="1" stroke-width="1" stroke-opacity="1" r="5"
                          class="jvectormap-marker jvectormap-element"></circle>
                        <circle data-index="2" cx="164.90458176337597" cy="166.3663341060206" fill="red"
                          stroke="transparent" fill-opacity="1" stroke-width="1" stroke-opacity="1" r="5"
                          class="jvectormap-marker jvectormap-element"></circle>
                        <circle data-index="3" cx="301.3793909008192" cy="214.70845311217795" fill="royalblue"
                          stroke="transparent" fill-opacity="1" stroke-width="1" stroke-opacity="1" r="5"
                          class="jvectormap-marker jvectormap-element"></circle>
                      </g>
                      <g></g>
              ...
              <div class="card-footer d-flex flex-wrap bg-white p-0">
                <div class="col-6 animate__animated animate__zoomIn animate__faster">
                  <div class="p-4">
                    <ul class="d-flex flex-column justify-content-between">
                      <li class="mb-2"><i class="mdi mdi-checkbox-blank-circle-outline mr-2"
                          style="color: #29cc97"></i>America <span class="float-right">5k</span></li>
                      <li><i class="mdi mdi-checkbox-blank-circle-outline mr-2" style="color: #4c84ff "></i>Australia
                        <span class="float-right">3k</span>
                      </li>
                    </ul>
                  </div>
                </div>
